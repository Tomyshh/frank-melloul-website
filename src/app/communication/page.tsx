...
const mockVideos = [
  {
    ...
    description: "Frank Melloul discusses the evolving landscape of global strategic advisory and its impact on international relations.",
  ...
  },
  {
    ...
    description: "An in-depth look at how effective diplomacy can unlock new market opportunities.",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
    id: 3,
    ...
    description: "Insights on empowering leaders to shape agendas and create lasting impact.",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
    id: 4,
    ...
    description: "Exploring effective approaches for entering complex international markets.",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
];
...
const pageTranslations = {
  en: {
    title: "Communication",
    subtitle: "Media appearances, interviews, and insights from Melloul & Partners",
    backToHome: "Back to Home",
    watchVideo: "Watch Video",
  },
  fr: {
    title: "Communication",
    subtitle: "Apparitions médiatiques, interviews et perspectives de Melloul & Partners",
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            {mockVideos.map((video, index) => (
              <VideoCard key={video.id} video={video} index={index} watchText={t.watchVideo} />
            ))}
          </div>
        </div>
      </main>
...
function VideoCard({ video, index, watchText }: { video: Video; index: number; watchText: string }) {
  return (
    <motion.article
      className="group"
      initial={{ opacity: 0, y: 30 }}
