...
const serviceIcons = [
  // Strategy icon
  <svg key="strategy" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <svg key="crisis" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
